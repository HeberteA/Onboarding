...
.stSelectbox div[data-baseweb="select"] > div {
    ...
    st.markdown(f"""
    <div style="background-color: transparent !important; background-image: linear-gradient(160deg, #1e1e1f 0%, #0a0a0c 100%) !important; border: 1px solid rgba(255, 255, 255, 0.1) !important; padding: 30px; border-radius: 10px !important; box-shadow: 0 15px 40px rgba(0, 0, 0, 0.7) !important;">
